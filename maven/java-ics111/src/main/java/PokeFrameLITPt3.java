...
/**
 * 
Assignment 25 - Extra Credit - Pokemon GUI Pt 3.
 * @author Tong Li
 *
 */
public class PokeFrameLITPt3 {
  ...
  private static JPanel initMainPanel() {
    ...
    newPokemonLabel.setHorizontalAlignment(SwingConstants.LEFT);
      ...
      public void actionPerformed(ActionEvent e) {
        ...
        if (name.isEmpty()) {
          JOptionPane.showMessageDialog(mainPanel.getParent(),
              //
              "Please enter a name for the Pokemon.", "Error", JOptionPane.ERROR_MESSAGE);
          return;
        }
