 ...
 * Assignment 15 Menu.
 * 
 * This program generates a list of random phone numbers based on user input. It
 * allows users to set the number of phone numbers to generate, print the list,
 * or exit the program.
 * 
 * @author Tong Li
 * @since 24/10
...
public class Assignment15LiTongMenu {
	...
	public static void main(String[] args) {
		...
		while (keepGoing) {
			...
			System.out.println("1 to change the amount of phone numbers to generate"
					+ " (defaults to 100)");
			...
			switch (temp) {
			   ...
			   case "1": 
				   ...
				   if (flag) {
					   System.out.println("The amount of numbers to generate has been changed to "
				           + limit);
				   } else {
	...
	/**
	 * Generates a random phone number with a 3-digit area code, 3-digit central
	 * office code, and a 4-digit line number.
	 * 
