...
public class ClassLoaderMain {
  ...
  public static void main(String[] args) throws ClassNotFoundException, InstantiationException, IllegalAccessException, NoSuchMethodException,
    ...
    // 这个类class的路径
    String classPath = "E:\\dev_workspace\\java\\java-study\\java-se-study\\java-se-classs-loader\\target\\classes";

    MyClassLoader myClassLoader = new MyClassLoader(classPath);
    // 类的全称
    String packageNamePath = "com.litongjava.study.classloader.demo01.Log";
